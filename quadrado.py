                ...
                if controle == 1:
                    ...
                    if y1==y2 or x1 == x2:
                        if x1==x2:
                            ...
                            função.bresenham_completo(window,x2,y2,x2-distancia,y2)
                            função.bresenham_completo(window,x2+distancia,y2,x2+distancia,y2-(distancia*2))
                            função.bresenham_completo(window,x2-distancia,y2,x2-distancia,y2-(distancia*2))
                            função.bresenham_completo(window,x2+distancia,y2-(distancia*2),x2-distancia,y2-(distancia*2))
                        if y1==y2:
                            if x1<x2:
                                distancia=x2-x1
                                função.bresenham_completo(window,x2,y2,x2,y2+distancia)
                                função.bresenham_completo(window,x2,y2,x2,y2-distancia)
                                função.bresenham_completo(window,x2,y2+distancia,x2+(distancia*2),y2+distancia)
                                função.bresenham_completo(window,x2,y2-distancia,x2+(distancia*2),y2-distancia)
                                função.bresenham_completo(window,x2+(distancia*2),y2+distancia,x2+(distancia*2),y2*distancia)
                        ...
                        if x1 < x2:
                            ...
                            função.bresenham_completo(window, x2, y2 + distancia, x2 + (distancia * 2), y2 + distancia)
                            função.bresenham_completo(window, x2, y2 - distancia, x2 + (distancia * 2), y2 - distancia)
                            função.bresenham_completo(window, x2 + (distancia * 2), y2 + distancia,
                                                      x2 + (distancia * 2), y2 * distancia)
